...
> 本文对 Graph RAG 做概要介绍，详细的开源项目分析和选型指南请参阅 [Graph RAG 开源项目全景：从微软 GraphRAG 到 LightRAG]({{< relref "post/RAG 与 LangChain/04-RAG 生态与选型/GraphRAG开源项目全景：从微软GraphRAG到LightRAG/index.md" >}})。
